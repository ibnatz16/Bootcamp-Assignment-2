...
var fs = require('fs'),
    ...
    listingData; //global variable used for parsing in readFile
...
fs.readFile('listings.json', 'utf8', function(err,schema){
  ...
  listingData.entries.forEach(function(element){ //forEach function used to look through each listing 
